...
public class OrderService {
  ...
  private static Map<String, Store> allStores = new HashMap<>();
  ...
  public static void initializeStores() {
    ...
    allStores.put(Constant.BRAZIL,
        new Store(Constant.BRAZIL,
            new Inventory(Constant.IPHONE, Constant.BRAZIL_IPHONE_PRICE,
                Constant.BRAZIL_IPHONE_COUNT),
  ...
  public static String processOrder(String input) {
    ...
    sb.append(price).append(":")
        .append(allStores.get(Constant.ARGENTINA).getInventories().get(Constant.IPHONE).itemCount)
        .append(":")
        .append(allStores.get(Constant.BRAZIL).getInventories().get(Constant.IPHONE).itemCount)
        .append(":")
        .append(allStores.get(Constant.ARGENTINA).getInventories().get(Constant.IPOD).itemCount)
        .append(":")
  ...
  private static int calculateCost(Store store, Order order) {
    ...
    for (Map.Entry<String, Inventory> entry : inventories.entrySet()) {
      cost += store.getInventories().get(entry.getValue().itemType).itemPrice * entry
          .getValue().itemCount;
    }
